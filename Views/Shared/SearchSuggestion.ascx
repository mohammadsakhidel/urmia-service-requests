<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SearchSuggestion.ascx.cs" Inherits="Views_Shared_SearchSuggestion" %>
                ...
                <asp:UpdatePanel ID="Up_FieldSelector" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:DropDownList ID="cmb_Fields" runat="server" CssClass="combobox" 
                            ...
                            <asp:ListItem Text="متن پیشنهاد" Value="1"></asp:ListItem>
                            <asp:ListItem Text="سازمان ارجاعی" Value="2"></asp:ListItem>
                            <asp:ListItem Text="وضعیت رسیدگی" Value="3"></asp:ListItem>
                            <asp:ListItem Text="تاریخ ثبت" Value="4"></asp:ListItem>
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
