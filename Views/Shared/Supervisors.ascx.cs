...
public partial class Views_Shared_Supervisors : System.Web.UI.UserControl
{
    ...
    public void LoadAll()
    {
        ...
        List<Supervisor> items = mr.GetAllSupervisors().ToList();
    ...
    protected void grid_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "DeleteItem")
            {
                ...
                mr.DeleteSupervisor(sup);
                //// delete acount:
                Membership.DeleteUser(sup.UserName, true);
                //// save:
                mr.Save();
                ////////////////////// Message box :
