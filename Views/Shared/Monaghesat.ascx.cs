...
public partial class Views_Shared_Monaghesat : System.Web.UI.UserControl
{
    ...
    public void LoadMonaghesat()
    {
        ServiceRepository sr = new ServiceRepository();
        IEnumerable<Monagheseh> items = sr.GetMonaghesat();
