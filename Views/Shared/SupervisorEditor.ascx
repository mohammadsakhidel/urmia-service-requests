<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SupervisorEditor.ascx.cs" Inherits="Views_Shared_SupervisorEditor" %>

<table border="0" cellpadding="3" cellspacing="0" style="margin : 10px 30px 10px 0;">
    <tr>
        <td align="left">
            نام :
        </td>
    ...
    <tr>
        ...
        <td align="right">
            <asp:TextBox ID="tb_Position" runat="server" Width="180" CssClass="textbox"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" CssClass="validator" 
                ControlToValidate="tb_Position" ValidationGroup="fillform"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td align="left">
