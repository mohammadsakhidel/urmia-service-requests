...
public partial class Views_Shared_Mozaiedat : System.Web.UI.UserControl
{
    ...
    public void LoadMozaiedat()
    {
        ServiceRepository sr = new ServiceRepository();
        IEnumerable<Mozaiedeh> items = sr.GetMozaiedat();
