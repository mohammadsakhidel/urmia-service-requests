<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Mozaiedat.ascx.cs" Inherits="Views_Shared_Mozaiedat" %>

<% if (Permissions.ServicesWritePermission) {%>

<div class="grid_tools" style="margin-bottom : 10px;">
    <a class="btn_new" href='<%= MyHelper.Url("~/Views/" + MyRoles.FolderName + "/ToolWindows/NewMozaiedeh.aspx") %>' onclick="return Open('<%= MyHelper.Url("~/Views/" + MyRoles.FolderName + "/ToolWindows/NewMozaiedeh.aspx") %>', '', 550, 350);"></a>
</div>
