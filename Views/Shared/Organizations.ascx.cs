...
public partial class Views_Shared_Organizations : System.Web.UI.UserControl
{
    ...
    public void LoadAll()
    {
        ...
        List<Organization> items = mr.GetAllOrganizations().ToList();
    ...
    protected void grid_items_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "DeleteItem")
            {
                ...
                mr.DeleteOrganization(organ);
                //// delete acount:
                Membership.DeleteUser(organ.UserName, true);
                //// save:
                mr.Save();
                ////////////////////// Message box :
