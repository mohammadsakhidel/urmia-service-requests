<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/OperatorPanel.master" AutoEventWireup="true" CodeFile="RoutedSuggestions.aspx.cs" Inherits="Views_Operators_RoutedSuggestions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_operatorpanel_main" Runat="Server">
    ...
    <div class="content">
        ...
        <div style="margin-top : 10px;" runat="server" id="pnl_list">
