<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/OperatorPanel.master" AutoEventWireup="true" CodeFile="PersuitSuggestion.aspx.cs" Inherits="Views_Operators_PersuitSuggestion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_operatorpanel_main" Runat="Server">
    ...
    <div class="content">
        ...
        <asp:Panel ID="pnl_Persuit" runat="server">
