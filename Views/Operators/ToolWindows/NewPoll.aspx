<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/ToolWindow.master" AutoEventWireup="true" CodeFile="NewPoll.aspx.cs" Inherits="Views_Operators_ToolWindows_NewPoll" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_tool_content" Runat="Server">
    ...
    <uc:PageTitle runat="server" Text="تعریف نظرسنجی جدید"/>
