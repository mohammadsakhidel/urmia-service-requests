<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/ToolWindow.master" AutoEventWireup="true" CodeFile="SendPoll.aspx.cs" Inherits="Views_Operators_ToolWindows_SendSms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_tool_content" Runat="Server">
    ...
    <uc:PageTitle ID="PageTitle1" runat="server" Text="ارسال پیامک نظرسنجی"/>
