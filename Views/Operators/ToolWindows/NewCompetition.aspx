<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/ToolWindow.master" AutoEventWireup="true" CodeFile="NewCompetition.aspx.cs" Inherits="Views_Operators_ToolWindows_NewCompetition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_tool_content" Runat="Server">
    ...
    <uc:PageTitle runat="server" Text="تعریف مسابقه جدید"/>
