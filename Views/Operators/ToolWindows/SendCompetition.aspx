<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/ToolWindow.master" AutoEventWireup="true" CodeFile="SendCompetition.aspx.cs" Inherits="Views_Operators_ToolWindows_SendCompetition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_tool_content" Runat="Server">
    ...
    <uc:PageTitle ID="PageTitle1" runat="server" Text="ارسال پیامک مسابقه"/>
