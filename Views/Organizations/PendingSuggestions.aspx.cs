...
public partial class Views_Organizations_PendingSuggestions : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            uc_SuggestionRoutings.Status = (int)MyEnums.SuggestionRoutingStatus.Pending;
