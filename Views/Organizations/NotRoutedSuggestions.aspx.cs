...
public partial class Views_Organizations_NotRoutedSuggestions : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                if (Permissions.SuggestionsViewPermission && Organization.CurrentUser.ViewUnroutedSuggestions)
                {
