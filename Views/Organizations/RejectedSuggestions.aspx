<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Masters/OrganPanel.master" AutoEventWireup="true" CodeFile="RejectedSuggestions.aspx.cs" Inherits="Views_Organizations_RejectedSuggestions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_organpanel_main" Runat="Server">
    ...
    <div class="content">
        ...
        <uc:PageTitle ID="PageTitle1" runat="server" Text="پیشنهادات و انتقادات » پیشنهادات رد شده"/>
