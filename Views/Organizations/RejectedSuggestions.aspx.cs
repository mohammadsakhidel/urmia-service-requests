...
public partial class Views_Organizations_RejectedSuggestions : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            uc_SuggestionRoutings.Status = (int)MyEnums.SuggestionRoutingStatus.Rejected;
