...
public partial class Views_Organizations_PrintSuggestions : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            suggestions = sr.FindSuggestions((List<Hashtable>)info.Information, Organization.CurrentUser).ToList();
